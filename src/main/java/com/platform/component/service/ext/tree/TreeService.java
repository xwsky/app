package com.platform.component.service.ext.tree;
...
public class TreeService{
	...
	*/
	...
	public Map<String, Object> loadData(String sql, Object[] args, Object pid, boolean expandedRoot, boolean chekced){
		...
		return bulidFinalTree(treeList);
	}
	 ...
	 * @return
	 */
	public Map<String, Object> bulidFinalTree(List<Map<String, Object>> finalList){		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("children", finalList);
		return map;
	}
